...
public class MyAspect {
    ...
    @Pointcut("execution(public * com.springaop.targat.TargetClass.test(..))")
    ...
    @AfterReturning(value = "pointcut()", returning = "th")
    public void afterReturning(JoinPoint joinPoint, Object th) {
        System.out.println("afterReturning：" + joinPoint.getSignature().getName() + "方法执行结束返回，参数："
                + Arrays.asList(joinPoint.getArgs()) + "，返回值：" + th);
    }
